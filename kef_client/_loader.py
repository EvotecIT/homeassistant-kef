"""Load the bundled KEF client implementation without importing Home Assistant."""
...
_INTERNAL_NAME = "_kef_client_internal"
_INTERNAL_ROOT = (
    Path(__file__).resolve().parents[1] / "custom_components" / "kef" / "kef_client"
)
...
def _ensure_internal_package():
    ...
    if spec is None or spec.loader is None:
        raise ImportError("Unable to load bundled KEF client package")
